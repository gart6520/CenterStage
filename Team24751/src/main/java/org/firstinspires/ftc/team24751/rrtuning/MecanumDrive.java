...
public final class MecanumDrive {
    public static class Params {
        ...
        public RevHubOrientationOnRobot.LogoFacingDirection logoFacingDirection = HUB_LOGO_DIRECTION;
        public RevHubOrientationOnRobot.UsbFacingDirection usbFacingDirection = HUB_USB_DIRECTION;

        // drive model parameters
        public double inPerTick = IN_PER_TICK;
        public double lateralInPerTick = LATERAL_MULTIPLER;
        public double trackWidthTicks = TRACK_WIDTH * TICK_PER_IN;

        // feedforward parameters (in tick units)
        public double kS = Constants.DRIVEBASE.kS;
        public double kV = Constants.DRIVEBASE.kV;
        public double kA = Constants.DRIVEBASE.kA;

        // path profile parameters (in inches)
        public double maxWheelVel = MAX_WHEEL_VEL;
        public double minProfileAccel = MIN_PROFILE_ACCEL;
        public double maxProfileAccel = MAX_PROFILE_ACCEL;

        // turn profile parameters (in radians)
        public double maxAngVel = MAX_ANG_VEL; // shared with path
        ...
        public double axialVelGain = AXIAL_VEL_GAIN;
        public double lateralVelGain = LATERAL_VEL_GAIN;
        public double headingVelGain = HEADING_VEL_GAIN; // shared with turn
    }
