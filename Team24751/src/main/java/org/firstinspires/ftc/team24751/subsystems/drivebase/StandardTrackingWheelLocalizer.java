...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.71; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 4.642; // in; offset of the lateral wheel; closer to front = positive
